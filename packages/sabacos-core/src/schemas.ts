...
export const profileRowSchema = z
  .object({
    ...
    language: z.enum(["en", "am"]).nullable().default(null),
    terms_accepted_at: z.string().nullable().default(null),
    terms_version: z.string().nullable().default(null),
...
export const productRowSchema = z
  .object({
    ...
    cost_halala: z.number().int().nonnegative().default(0),
...
export const createProductSchema = z.object({
  ...
  costHalala: z.number().int().nonnegative().optional(),
...
export const referralRewardRowSchema = z
  .object({
    ...
    available_at: z.string().nullable().default(null),
...
export const referralSettingsRowSchema = z
  .object({
    ...
    referred_discount_percent: z.number().int().default(5),
    affiliate_percent: z.number().int().default(10),
    ...
    reward_budget_pct: z.number().default(15),
    top_prize_cost_halala: z.number().int().default(50000),
    adaptive_enabled: z.boolean().default(false),
    last_adjustment_date: z.string().nullable().default(null),
    adjustment_day_of_week: z.number().int().default(1),
    daily_spend_cap_halala: z.number().int().default(0),
    daily_spend_cap_enabled: z.boolean().default(false),
    guardrail_commission_min: z.number().int().default(3),
    guardrail_commission_max: z.number().int().default(10),
    guardrail_spin_cap_min: z.number().int().default(1),
    guardrail_spin_cap_max: z.number().int().default(5),
    guardrail_prize_cost_min: z.number().int().default(30000),
    guardrail_prize_cost_max: z.number().int().default(150000),
    guardrail_max_budget_pct: z.number().default(25),
    created_at: z.string(),
    updated_at: z.string(),
  })
  .transform(
    (r): ReferralSettings => ({
      ...
      referredDiscountPercent: r.referred_discount_percent ?? 5,
      affiliatePercent: r.affiliate_percent ?? 10,
      ...
      rewardBudgetPct: r.reward_budget_pct ?? 15,
      topPrizeCostHalala: r.top_prize_cost_halala ?? 50000,
      adaptiveEnabled: r.adaptive_enabled ?? false,
      lastAdjustmentDate: r.last_adjustment_date ?? null,
      adjustmentDayOfWeek: r.adjustment_day_of_week ?? 1,
      dailySpendCapHalala: r.daily_spend_cap_halala ?? 0,
      dailySpendCapEnabled: r.daily_spend_cap_enabled ?? false,
      guardrailCommissionMin: r.guardrail_commission_min ?? 3,
      guardrailCommissionMax: r.guardrail_commission_max ?? 10,
      guardrailSpinCapMin: r.guardrail_spin_cap_min ?? 1,
      guardrailSpinCapMax: r.guardrail_spin_cap_max ?? 5,
      guardrailPrizeCostMin: r.guardrail_prize_cost_min ?? 30000,
      guardrailPrizeCostMax: r.guardrail_prize_cost_max ?? 150000,
      guardrailMaxBudgetPct: r.guardrail_max_budget_pct ?? 25,
      createdAt: r.created_at,
      updatedAt: r.updated_at,
    }),
  );

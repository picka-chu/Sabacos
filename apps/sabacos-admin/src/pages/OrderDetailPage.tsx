  ...
  return (
    <>
      ...
      <div className="grid" style={{ gridTemplateColumns: "2fr 1fr", alignItems: "start" }}>
        <div>
          <div className="card">
            <h3 style={{ margin: "0 0 12px", fontSize: 15 }}>Items</h3>
            {order.items.map((item) => (
              <div key={item.id} className="row" style={{ justifyContent: "space-between", padding: "6px 0" }}>
                ...
                <strong>{formatETB(item.subtotalHalala)}</strong>
              </div>
            ))}
          ...
          <div className="card" style={{ marginTop: 14 }}>
            <h3 style={{ margin: "0 0 12px", fontSize: 15 }}>Timeline</h3>
        ...
        <div>
          <div className="card">
            ...
            <p style={{ margin: "4px 0 0", lineHeight: 1.5 }}>{order.address}</p>
            {order.note && (
              <p style={{ margin: "10px 0 0", fontStyle: "italic" }}>“{order.note}”</p>
            )}
          </div>
          ...
          <div className="card" style={{ marginTop: 14 }}>
            <h3 style={{ margin: "0 0 6px", fontSize: 15 }}>Meta</h3>
